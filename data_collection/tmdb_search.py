        ...
        if results:
            ...
            if details_response.status_code == 200:
                ...
                return{
                    ...
                    'Production Companies': [company['name'] for company in metadata.get('prodcution_companies', [])],
                    'Production Countries': [country['name'] for country in metadata.get('prodcution_countries', [])],
...
def test():
    movie = 'Jaws'
    metadata = TMDB_Metadata(API, movie)
    print(metadata)
